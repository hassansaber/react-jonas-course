...
amount will be registered in the 'loan' state, and it will be added to the balance. If the condition is not met,
...
function BankAccount() {
  ...
  const { balance, isActive, loan } = state
